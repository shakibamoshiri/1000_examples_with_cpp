...
int main(){
    ...
    system_clock::duration   du = tp.time_since_epoch();

    std::cout << "period: " << tp.time_since_epoch().count() << '\n';
    std::cout << "seconds: " << du.count() * system_clock::period::num / system_clock::period::den<< '\n';

}

/* output
period: 1491818026877749708
seconds: 1491818026
