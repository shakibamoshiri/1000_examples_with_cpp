...
int main(){
    ...
    endl( std::cout << std::is_integral<int>::value );
    endl( std::cout << std::is_integral<float>::value );
    endl( std::cout << std::is_integral<int*>::value );
    endl( std::cout << std::is_integral<A>::value );

    //static_assert( std::is_integral<123>::value, "123 is not a integral");

    std::cout << _()(123) << std::endl;
