...
// types T and false for the unsigned types. This constant is meaningful for all specializations.
...
int main(){
    ...
    // std::numeric_limits<one>is_signed // ERROR
    // std::numeric_limits<two>is_signed // ERROR
}
