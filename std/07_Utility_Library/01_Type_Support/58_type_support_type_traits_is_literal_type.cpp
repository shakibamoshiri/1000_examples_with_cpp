...
//    value equal true. For any other type, value is false. The behavior is undefined
//    if std::remove_all_extents_t<T> is an incomplete type and not (possibly cv-qualified) void.
