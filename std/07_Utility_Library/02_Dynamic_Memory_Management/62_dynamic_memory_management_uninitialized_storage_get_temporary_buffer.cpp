...
// Allocates uninitialized contiguous storage, which should by sufficient
// to store up count adjacent objects of type T. The request is non-binging
// and the implementation may allocate less or more than necessary to store
// count adjacent object.
