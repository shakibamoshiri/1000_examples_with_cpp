...
int main(){
    ...
    std::cout<<"v:\t";      for(const int i: v) std::cout<<i<<' ';

    // second alternative
    // Initialize with default values 0,1,2,3,4 from a lambda function
    // Equivalent to std::iota (v.begin(), v.end(), 0);
    int n=0;
    // or int n={0}; by initializer list
    // here the lambda function captures the n variable by reference
    std::generate(v.begin(), v.end(), [&n]{return n++;});
    std::cout<<"\nv:\t";    for(const int i: v) std::cout<<i<<' ';
