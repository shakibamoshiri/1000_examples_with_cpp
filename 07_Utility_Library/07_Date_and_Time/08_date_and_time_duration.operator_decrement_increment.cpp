...
int main (){
    ...
    std::chrono::minutes m = ++h;   // now it equal to 120 minutes

    std::cout << "now m is: " << m.count() << std::endl;

    m--;    // decrements the minutes

    std::cout << "after decrementing m is: " << m.count() << std::endl;
