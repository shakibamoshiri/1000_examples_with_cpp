...
//    If T is a standard layout type (that is, a scalar type, a standard-layout class, or an
//    array of such type/class, possibly cv-qualified), provides the member constant
