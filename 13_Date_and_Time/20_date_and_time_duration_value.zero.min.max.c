...
*/
/// std::chrono::duration_value
//  The std::chrono::duration_value defines three common durations:
//  std::chorno::duration_value::zero
//  std::chorno::duration_value::min
//  std::chorno::duration_value::max
//
//  The zero, min and max methods in std::chrono::duration forward their work to these methods.
//  This type can be specialized if the representation Rep required
//  a specific implementation to return these duration objects.
...
int main (){
    // has no example
    // or you can see the previous examples
}
