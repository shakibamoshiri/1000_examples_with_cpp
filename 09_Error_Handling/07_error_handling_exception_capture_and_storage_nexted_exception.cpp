...
//  std::nested_exception is a polymorphic mixin class which can
//  capture and store the current exception, making it possible
//  to nest exception of arbitrary types within each other.
