...
//  the current exception object and creates an std::exception_ptr that holds either
//  a copy or a reference to that exception object (it is implementation-defined if
//  a copy is made).
