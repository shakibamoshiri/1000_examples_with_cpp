...
int main(){
    ...
    std::reverse_iterator<std::string::iterator> rits=str.rbegin(); // now rits points to '?'

    rits[0]='!';    // modifies '?' to '!'
    std::cout<<"str after modifying:\t"<<str<<std::endl;

    *rits='?';
    std::cout<<"str after another modifying:\t"<<str<<std::endl;
