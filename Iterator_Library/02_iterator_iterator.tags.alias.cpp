...
// make as alias iterator_category
template<typename T> using it_c = typename std::iterator_traits<T>::iterator_category;

int main(){

    std::vector<int> vector;
    it_c<std::vector<int>::iterator> v;
    alg(vector.begin(),vector.end(),v);   // calls random access

    std::list<int> list;
    it_c<std::list<int>::iterator> l;
    alg(list.begin(),list.end(),l);       // calls bidirectional
