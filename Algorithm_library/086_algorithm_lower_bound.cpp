...
// [first,last) that is not less then (i.e greater or equal to) value.
// The range [first,last) must be at least partially sorted, i.e.
// partitioned with respect to the expression element < value or
// comp ( element, value). A fully-sorted range meets this criterion,
// as does a range resulting from a call to std::partition.
