...
int main(){
    ...
    // using unique, but with predicateBinary function
    str.erase(
              std::unique(str.begin(),                                      // beginning of the string
                          str.end(),                                        // ending of the string
                          [](char a,char b){ return a==' ' && b==' ';}),    // lambda expression to recognize consecutive space in the str
              str.end());
