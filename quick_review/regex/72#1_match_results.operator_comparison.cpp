...
/// std::match_results operator == and != ( comparison )
...
int main(  ){
    ...
    std::regex_search( c_string, third,  std::regex( "you" ) );

    if( first == third )  puts( "okay first == third" );
    if( first != second ) puts( "okay first != second" );
