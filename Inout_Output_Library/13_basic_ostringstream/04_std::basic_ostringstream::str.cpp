...
**/
/// 04_std::basic_ostringstream::str
/**
std::basic_string<CharT,Traits,Allocator> str() const;
void str( const std::basic_string<CharT,Traits,Allocator>& new_str);

Manages the contents of the underlying string stream.
1)  Returns a copy of the underlying string as if by calling rdbuf()->str().
2)  Returns the contents of the underlying string as if by calling rdbuf()->str(new_str).
